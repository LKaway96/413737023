...
function draw() {
  background("#003049");
  translate(mouseX,mouseY)//設定原點在游標位置
  ...
  for(let i=0; i<20; i=i+1){
    ...
    stroke(r,g,b)
    rotate(sin(angle-i*2)*40)//三角函數sin的值介於-1~1間，*40之後，旋轉較度介於-40~40間
    rect(0,0,100+(mouseX/2)-i*3.5,100+(mouseY/2)-i*3.5,20)//方形(600,600)
}
